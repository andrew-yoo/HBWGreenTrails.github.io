    ...
    const Leaderboard: React.FC = () => {
        ...
        return (
            <div >
                ...
                <Navbar />
                <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'nowrap', position: 'relative', zIndex: 1, justifyContent: 'center', gap: '15px', padding: '20px', maxWidth: '1400px', margin: '0 auto', overflowX: 'auto' }}>
